      ...
      <div className="container px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold font-display mb-6">
            Instruments of <span className="text-foreground">my craft</span>
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Not a checklist — a constellation of languages, frameworks, and quiet companions that help thoughts become things.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            {[
              ...
              { label: "Databases", items: "MySQL, MongoDB, PostgreSQL, Supabase, Firebase" },
            ].map((category, index) => (
              <motion.div
                key={category.label}
                initial={{ opacity: 0, y: 20 }}
