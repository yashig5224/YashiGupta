...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="relative">
      ...
      <Timeline
        data={projectsData}
        heading="Things I've quietly built"
        subheading="Each one began as a stray thought. Some stayed weekend experiments; others grew into something I'm proud to share."
      />
    </section>
  );
};
