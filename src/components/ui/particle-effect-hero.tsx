...
export function ParticleHero({
  title = "Yashi Gupta",
  subtitle = "Where curiosity meets code, and pixels learn to think.",
  description = "I sketch ideas in logic and color — turning quiet thoughts into interfaces that move, respond, and feel a little alive."
}: ParticleHeroProps) {
  return (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold font-display tracking-tight mb-6">
              <span className="sr-only">Yashi Gupta — Creative Web Developer. </span>
              <span aria-hidden="true">Somewhere between </span>
              <span className="text-foreground" aria-hidden="true">logic & wonder</span>
            </h1>
